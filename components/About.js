    ...
    <div className="about-page-grid">
      <div className="about-page-grid__card">
        ...
        <div className="about-page-grid__card__side about-page-grid__card__side--back about-page-grid__card__side--back--1">
          I watch all kinds of TV series. When I was in middle school, I
          stumbled upon this series called charmed, it's about 3 witch sisters
          fighting demons. I know the plot sounds cheesy but I love that show
      ...
      <div className="about-page-grid__card">
        ...
        <div className="about-page-grid__card__side about-page-grid__card__side--back about-page-grid__card__side--back--2">
          ...
          give it a shot and see how it goes. At first, I subscribed to datacamp
          ...
          get my hands dirty with actually building stuff, so I looked around
          the internet and purchased The Complete Web Development Bootcamp
          taught by Colt Steele. After that course, I just can't stop digging
          deeper into the web field.
        </div>
      </div>
      <div className="about-page-grid__card">
        ...
        <div className="about-page-grid__card__side about-page-grid__card__side--back about-page-grid__card__side--back--3">
          ...
          consider them to be meaningless. I love to talk about cool
          technologies and new software development trends with other people who
          share the same passion. I love to learn from people with different
          backgrounds to gain a brand new perspective or people with more
          experience to solve problems more elegantly.
        </div>
      </div>
    </div>
